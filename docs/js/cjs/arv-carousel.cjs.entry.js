...
const Carousel = class {
    ...
    render() {
        const ImageContent = () => {
            ...
            return (index.h("div", { class: classNames }, content.map(d => {
                const bg = `url(${d.imageUrl})`;
                return (index.h("div", { class: "imageContentItem", style: { 'background-image': bg } }));
            })));
        };
        return (index.h("div", { class: "root" }, index.h("div", { class: "content" }, Boolean(this.imageSource.length) && index.h(ImageContent, null), !Boolean(this.imageSource.length) && (index.h("arv-flex", { justify: "center", items: "center" }, index.h("arv-icon", { icon: "image" })))), index.h("div", { class: "control" }, index.h("arv-flex", { justify: "between", items: "center" }, this.imageSource.length > 1 && (index.h("div", { onClick: this.clickLeft.bind(this), class: "control-item control-item__left" }, index.h("arv-flex", { justify: "center", items: "center" }, index.h("arv-button", { color: "light", size: "large", icon: "chevron_left", variant: "ghost-icon" })))), Boolean(this.externalUrl) && (index.h("a", { href: this.externalUrl, target: this.target, "aria-hidden": "true", class: "middle" })), this.imageSource.length > 1 && (index.h("div", { onClick: this.clickRight.bind(this), class: "control-item control-item__right" }, index.h("arv-flex", { justify: "center", items: "center" }, index.h("arv-button", { color: "light", size: "large", icon: "chevron_right", variant: "ghost-icon" }))))))));
    }

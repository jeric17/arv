...
const Stepper = class {
    constructor(hostRef) {
        ...
        this.arvItemClick = index.createEvent(this, "arvItemClick", 7);
    }
    /**
    ...
    render() {
        const hostCls = Object.assign({}, helpers.generateAttrValue(this.color));
        const stepsLength = this.stepperSteps.length - 1;
        return (index.h(index.Host, { class: hostCls }, this.stepperSteps.map((step, index$1) => {
            const stepIndex = index$1 + 1;
            /**
             * Line separator between steps.
             */
            const divider = index.h("div", { class: "divider" });
            /**
             * Will be visible if the step item is tag done.
             */
            const checkItem = (index.h("div", { class: "index" }, index.h("arv-icon", { icon: "check" })));
            /**
             * Step item classList.
             */
            const stepperCls = {
             ...
             * Step number ui.
             */
            const indexItem = index.h("div", { class: "index" }, stepIndex);
            return (index.h("div", { class: stepperCls, onClick: () => this.itemClick(index$1) }, step.done ? checkItem : indexItem, index.h("div", { class: "title" }, step.title), (index$1 < stepsLength) && divider));
        })));
    }

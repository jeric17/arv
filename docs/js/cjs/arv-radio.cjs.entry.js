...
const Radio = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { class: hostCls, style: hostStyles, onClick: this.change }, index.h("label", { class: "label" }, this.label), index.h("div", { class: "control" }, index.h("div", { class: "indicator" })), index.h("input", { disabled: this.disabled, type: "radio", value: this.value, checked: this.checked })));
    }
};
Radio.style = radioCss;

exports.arv_radio = Radio;

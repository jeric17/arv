...
var Menu = /** @class */ (function () {
    function Menu(hostRef) {
        ...
        this.menuTriggerClick = function () {
            _this.toggle();
        };
        this.menuListClick = function () {
            setTimeout(function () {
                _this.isOpen = false;
            }, _this.delay);
        };
    }
    Menu.prototype.blurHandler = function () {
        this.isOpen = false;
    };
    Menu.prototype.toggle = function () {
        ...
        if (this.isOpen) {
            ...
            if (this.yPosition === 'top') {
                var menutriggerEl = this.el.shadowRoot.querySelector('.menu-trigger');

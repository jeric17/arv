...
var Loader = /** @class */ (function () {
    ...
    Loader.prototype.render = function () {
        ...
        return (h("div", { class: rootClassNames }, h("arv-flex", { layout: "column", justify: "center", items: "center" }, h("div", { class: spinnerClassNames }), h("slot", null))));
    };
    return Loader;
}());
Loader.style = loaderCss;
export { Loader as arv_loader };

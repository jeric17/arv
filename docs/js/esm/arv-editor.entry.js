...
const Editor = class {
    ...
    render() {
        ...
        const controlsWrapper = (h("div", { class: "control" }, controls.map((d, i) => (h("arv-button", { key: i, onClick: this.comm.bind(this, d.comm), icon: d.icon, variant: "flat-icon", rounded: false }))), h("arv-button", { onClick: this.showLink.bind(this), icon: "insert_link", variant: "flat-icon", rounded: false }), h("arv-menu", { xPosition: "left" }, h("div", { slot: "menu" }, h("arv-button", { icon: "title", variant: "flat-icon", rounded: false })), h("div", { class: "headingList", slot: "menu-list" }, headings.map((d, i) => (h("arv-button", { rounded: false, key: i, onClick: this.formatBlock.bind(this, d), full: true }, "Heading ", i + 1))))), h("arv-menu", { xPosition: "left" }, h("div", { slot: "menu" }, h("arv-button", { icon: "format_size", variant: "flat-icon", rounded: false })), h("div", { class: "headingList", slot: "menu-list" }, sizes.map(d => (h("arv-button", { rounded: false, key: d, onClick: this.size.bind(this, d), full: true }, d))))), h("span", { class: "inputWrapper" }, h("arv-icon", { onClick: this.imageGet.bind(this), icon: "image" }), !Boolean(this.handleImage) && (h("input", { class: "input", onChange: this.getImage.bind(this), type: "file", accept: "image/*" })))));
